...
enum EnemyType { GRUNT, SHOOTER, FLYER, SKATING_GRUNT, SKATING_SHOOTER, BRUTE, ROLLER_SKATER, BEACH_BUM, SEAGULL, ROADIE, GROUPIE, PYRO_TECH, SPEAKER_STACK, PUNK_ROCKER, MOHAWK_DIVER, SPRAY_PAINTER, BIKER }
