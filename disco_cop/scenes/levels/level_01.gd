extends LevelBase
## Level 01: Disco Rink. Flat skating rink with 3 combat zones + boss.

var _grunt_scene: PackedScene = preload("res://scenes/enemies/skating_grunt.tscn")
var _shooter_scene: PackedScene = preload("res://scenes/enemies/skating_shooter.tscn")
...
func _build_scroll_lock_zones() -> void:
	# Zone 1 (x:400-1200): warm-up — grunts + 1 shooter
	...
	spawner1.enemy_scenes = [_grunt_scene, _grunt_scene, _shooter_scene]
	...
	# Zone 2 (x:1600-2600): escalation — mixed enemies
	...
	spawner2.enemy_scenes = [_grunt_scene, _shooter_scene, _shooter_scene, _flyer_scene]
	...
	# Zone 3 (x:3000-4000): pre-boss gauntlet
	...
	spawner3.enemy_scenes = [_grunt_scene, _grunt_scene, _shooter_scene, _flyer_scene, _flyer_scene]
	spawner3.spawn_count = 6
